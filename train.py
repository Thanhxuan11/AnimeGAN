...
def parse_args():
    ...
    parser.add_argument('--style_dataset', type=str, default='Tabe', help='dataset_name')

    parser.add_argument('--init_G_epoch', type=int, default=5, help='The number of epochs for generator initialization')
    parser.add_argument('--epoch', type=int, default=95, help='The number of epochs to run')
...
def train():
    ...
    with tf.Session(config=tf.ConfigProto(allow_soft_placement=True, 
                                           ...
                                           intra_op_parallelism_threads=64)) as sess:
